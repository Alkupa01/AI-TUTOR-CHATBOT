...
(function(FunctionDeclarationSchemaType$1) {
	/** String type. */
	FunctionDeclarationSchemaType$1["STRING"] = "STRING";
	/** Number type. */
	FunctionDeclarationSchemaType$1["NUMBER"] = "NUMBER";
	/** Integer type. */
	FunctionDeclarationSchemaType$1["INTEGER"] = "INTEGER";
	/** Boolean type. */
	FunctionDeclarationSchemaType$1["BOOLEAN"] = "BOOLEAN";
	/** Array type. */
	FunctionDeclarationSchemaType$1["ARRAY"] = "ARRAY";
	/** Object type. */
	FunctionDeclarationSchemaType$1["OBJECT"] = "OBJECT";
...
function getText(response) {
	...
	if ((_b = (_a = response.candidates) === null || _a === void 0 ? void 0 : _a[0].content) === null || _b === void 0 ? void 0 : _b.parts) {
		for (const part of (_d = (_c = response.candidates) === null || _c === void 0 ? void 0 : _c[0].content) === null || _d === void 0 ? void 0 : _d.parts) if (part.text) textStrings.push(part.text);
	}
...
function aggregateResponses(responses) {
	...
	for (const response of responses) if (response.candidates) for (const candidate of response.candidates) {
...
async function generateContentStream(apiKey, model, params, requestOptions) {
	return processStream(await makeRequest(model, Task.STREAM_GENERATE_CONTENT, apiKey, true, JSON.stringify(params), requestOptions));
}
async function generateContent(apiKey, model, params, requestOptions) {
	return { response: addHelpers(await (await makeRequest(model, Task.GENERATE_CONTENT, apiKey, false, JSON.stringify(params), requestOptions)).json()) };
}
/**
* @license
* Copyright 2024 Google LLC
...
async function countTokens(apiKey, model, params, requestOptions) {
	return (await makeRequest(model, Task.COUNT_TOKENS, apiKey, false, JSON.stringify(Object.assign(Object.assign({}, params), { model })), requestOptions)).json();
}
/**
* @license
* Copyright 2024 Google LLC
...
async function embedContent(apiKey, model, params, requestOptions) {
	return (await makeRequest(model, Task.EMBED_CONTENT, apiKey, false, JSON.stringify(params), requestOptions)).json();
}
async function batchEmbedContents(apiKey, model, params, requestOptions) {
	const requestsWithModel = params.requests.map((request) => {
		return Object.assign(Object.assign({}, request), { model });
	});
	return (await makeRequest(model, Task.BATCH_EMBED_CONTENTS, apiKey, false, JSON.stringify({ requests: requestsWithModel }), requestOptions)).json();
}
/**
* @license
* Copyright 2024 Google LLC
